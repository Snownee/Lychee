...
Repeatability means this interaction can be bulk-processed. The ["place block" action](post-action.md#place-block) cancels repeatability because it is nonsense to place single block at a position for multiple times.
