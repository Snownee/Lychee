...
!!! note "Format"
    ...
    | local_pos       | local position ^optional^{ title="default: [0,0,0]" } | number\[3]     |
    | rotation        | rotation ^optional^{ title="default: [0,0,0]" }       | number\[3]     |
    | rotation_offset | rotation offset ^optional^                            | number\[3]     |
