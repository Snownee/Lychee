...
public class LycheeKubeJSPlugin implements KubeJSPlugin {
	...
	public void registerBindings(BindingRegistry bindings) {
		...
		bindings.add("LycheeLootContextParams", LootContextKeys.class);
	...
	public void registerTypeWrappers(TypeWrapperRegistry registry) {
		registry.register(
				ContextKey.class, o -> {
					if (o instanceof ContextKey<?> param) {
						return param;
					}
					if (o instanceof CharSequence || o instanceof Identifier) {
						return LootContextKeys.ALL.get(KUtil.trimRL(o.toString()));
					}
					return null;
				});
	}
