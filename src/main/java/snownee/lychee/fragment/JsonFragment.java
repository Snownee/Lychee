...
public class JsonFragment {
	...
	record Anchor(JsonElement fragment, boolean spread, Map<String, JsonElement> vars) {
	...
	record Context(Function<String, JsonElement> getter, Map<String, JsonElement> vars) {
