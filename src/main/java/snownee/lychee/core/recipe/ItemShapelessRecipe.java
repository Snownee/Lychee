...
public abstract class ItemShapelessRecipe extends LycheeRecipe<ItemShapelessContext> implements Comparable<ItemShapelessRecipe> {
	...
	@Override
	public int compareTo(ItemShapelessRecipe that) {
		int i;
